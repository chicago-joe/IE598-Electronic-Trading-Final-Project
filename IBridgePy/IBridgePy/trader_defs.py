...
class Portfolio:
    ...
    def cash(self):  # sames as quantopian
        return self.parentTrader.brokerService.get_account_info(self.accountCode, 'TotalCashValue')

    @property
    def pnl(self):  # sames as quantopian
        return self.parentTrader.brokerService.get_account_info(self.accountCode, 'UnrealizedPnL')

    @property
    def portfolio_value(self):  # sames as quantopian
        return self.parentTrader.brokerService.get_account_info(self.accountCode, 'NetLiquidation')

    @property
    def positions_value(self):  # sames as quantopian
        return self.parentTrader.brokerService.get_account_info(self.accountCode, 'GrossPositionValue')
    ...
    @property
    def orderStatusBook(self):
        """

        :return: a dictionary, keyed by orderId, value = IbridgepyOrder
        """
        return self.parentTrader.brokerService.get_all_orders(self.accountCode)
