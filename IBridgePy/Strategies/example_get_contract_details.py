...
def handle_data(context, data):
    ...
    # The field can be either a string or a list
    ...
    # The expected return is {'tradingClass': 'NMS'}   National Market System
    print(get_contract_details(secType='STK', symbol='AAPL', field='tradingClass'))

    # The expected return is a pandas dataframe,
    # Columns include contractName, contract, str_security, expiry, strike, right, multiplier
