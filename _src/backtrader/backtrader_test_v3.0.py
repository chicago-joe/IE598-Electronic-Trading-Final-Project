    ...
    def next(self):
        ...
        if not self.position:
            ...
            if ((self.dataclose_x[0]- self.params.m*self.dataclose_y[0]-self.params.b) > (self.params.std*self.params.muti+self.params.avg)):
                ...
                self.order = self.buy(self.datas[1],size=self.params.m*self.params.size)
            ...
            # BP-m*RSDA-b <-(1.5*std + 0.5)
                ...
                self.order = self.sell(self.datas[1],size=self.params.m*self.params.size)
