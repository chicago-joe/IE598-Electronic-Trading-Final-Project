...
class TestStrategy(bt.Strategy):    # Create a Strategy
    ...
    def __init__(self):
        self.dataclose = self.datas[0].close  # Keep a reference to the "close" line in the _data[0] dataseries
...
if __name__ == '__main__':
    ...
    data = bt.feeds.PandasData(dataname=dataframe)  # create a _data feed
    
    cerebro.adddata(data)  # add _data feed to Cerebro
